...
import Brunson from '../images/jaylen_brunson.jpg';
...
const NextGame2 = () => {
  ...
  const knicksInjuries = [
    {
      image: <img src={Brunson} className="player-image" alt="Jaylen Brunson" />,
      name: 'Jaylen Brunson',
      injury: 'Has been ruled out (Fracture in left hand (successful surgery))',
    },
    {
      image: <img src={Robinson} className="player-image" alt="Mitchell Robinson" />,
        ...
        <div className="games-container">
          <div className="games-text-section">
            ...
            <div className="team-logo">
              <img src={KnicksLogo} alt="New York Knicks Logo" />
            </div>
            <p>
